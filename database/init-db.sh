...
# databases
for service in idam ccd_user_profile ccd_definition ccd_data evidence ccd_definition_designer cmc dbrefdata dbuserprofile role_assignment letter_tracking; do
