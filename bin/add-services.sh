...
${dir}/utils/idam-create-service.sh "cmc_citizen_frontend" "cmc_citizen" "12345678" "http://localhost:3002/receiver" "true" "profile openid roles manage-user create-user search-user"
