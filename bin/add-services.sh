...
${dir}/utils/idam-create-service.sh "civil" "civil" "OOOOOOOOOOOOOOOO" "https://localhost:9000/oauth2/callback" "false" "profile openid roles manage-user create-user search-user"
